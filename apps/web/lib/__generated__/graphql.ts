...
export type FeedbacksQuery = { __typename?: 'Query', feedbacks: { __typename?: 'FeedbackConnection', edges: Array<{ __typename?: 'FeedbackEdge', cursor: string, node: { __typename?: 'Feedback', rating: number, text: string, createdAt: string, event: { __typename?: 'Event', name: string }, user: { __typename?: 'User', email: string, name: string } } }> } };
